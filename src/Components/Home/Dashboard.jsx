...
const Dashboard = () => {
    return (
        <div className="pt-[60px] md:pt-[80px] bg-[#F5F5F5] px-4">
            <h1 className="text-[#001931] text-center font-bold text-4xl md:text-7xl leading-tight">We Build <br className="hidden md:block" /> <span className="bg-gradient-to-r from-[#632EE3] via-[#00D390] to-[#632EE3] text-transparent bg-clip-text animate-shimmer drop-shadow-sm pb-2">Productive</span> Apps</h1>
            <p className="text-[#627382] text-center text-base md:text-xl font-normal mt-6 max-w-3xl mx-auto">At HERO.IO, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting. <br className="hidden md:block" />Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
